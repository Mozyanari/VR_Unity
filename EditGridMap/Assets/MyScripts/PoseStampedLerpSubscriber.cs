...
{
    public class PoseStampedLerpSubscriber : Subscriber<Messages.Geometry.PoseStamped>
    {
        public Transform PublishedTransform;
        private Vector3 before_position;
        private Quaternion before_rotation;
        ...
        private void Update()
        {
            PublishedTransform.position = Vector3.Lerp(before_position, position, 0.1f);
            PublishedTransform.rotation = Quaternion.Lerp(before_rotation, rotation, 0.1f);
